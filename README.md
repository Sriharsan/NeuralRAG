...
```shell
streamlit run chatbot/chatbot_app.py -- --model deepseek-r1:7b --max-new-tokens 1024
```
...
```shell
streamlit run chatbot/rag_chatbot_app.py -- --model deep-seek-r1:7b --k 2 --synthesis-strategy async-tree-summarization
```
